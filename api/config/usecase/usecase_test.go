...
func initConfigUsecase(repository config.Repository, store cache.Store) *configUsecase {
	...
	usecase.RegisterTile(pingApi.PingTileType, []coreModels.Variant{coreModels.DefaultVariant}, MinimalVersion)
	usecase.RegisterTile(portApi.PortTileType, []coreModels.Variant{coreModels.DefaultVariant}, MinimalVersion)
	usecase.RegisterTile(jenkinsApi.JenkinsBuildTileType, []coreModels.Variant{coreModels.DefaultVariant}, MinimalVersion)
	usecase.RegisterTile(pingdomApi.PingdomCheckTileType, []coreModels.Variant{coreModels.DefaultVariant}, MinimalVersion)
